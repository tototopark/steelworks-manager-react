# 작업 체크리스트 - CV/커버레터 보완 및 실제 배포 방안 수립
...
- [x] 실제 웹 서비스 배포 가이드 문서 작성
  ...
  - [x] 클라우드(Render.com / Fly.io) 가상 머신 배포 방안 명세
  - [x] 파일 저장: [수정/수정_react_121_배포가이드.md](file:///f:/pe/public_html/steelworks-manager-react/수정/수정_react_121_배포가이드.md)
