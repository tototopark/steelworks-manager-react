...
CMD python -c "import os; import sys; sys.path.append(os.path.abspath('.')); import tests.db_init as db_init; db_init.create_tables(); import importlib; seeder=importlib.import_module('skills.999_db_seeder'); seeder.seed_database()" && \
